...
/**
 * @minions-repos/cli — CLI for Minions Repos
 *
...
import { customTypes } from '@minions-repos/sdk';
...
program
    ...
    .action(() => {
        console.log(chalk.bold('Minions Repos'));
        console.log(chalk.dim('GitHub repo definitions, workflow templates, label sets, and branch protection rules'));
        console.log('');
        console.log(`  SDK:    ${chalk.cyan('@minions-repos/sdk')}`);
        console.log(`  CLI:    ${chalk.cyan('@minions-repos/cli')}`);
        console.log(`  Python: ${chalk.cyan('minions-repos')}`);
