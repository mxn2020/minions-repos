...
const siteUrl = isProd ? 'https://repos.minions.help' : (isDev ? 'https://repos.minions.help' : 'http://localhost:4321');
...
export default defineConfig({
    ...
    integrations: [
        starlight({
            ...
            social: [
                { icon: 'github', label: 'GitHub', href: 'https://github.com/mxn2020/minions-repos' },
                { icon: 'external', label: 'App', href: 'https://repos.minions.wtf' },
            ],
            sidebar: [
                {
