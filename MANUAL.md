# Manual Setup Steps for Minions Repos
...
Go to **GitHub → mxn2020/minions-repos → Settings → Secrets and variables → Actions** and add:

| Secret | Description | Where to get it |
|--------|-------------|-----------------|
| `NPM_TOKEN` | npm publish token | [npmjs.com → Access Tokens](https://www.npmjs.com/settings/~/tokens) |
| `PYPI_TOKEN` | PyPI API token for `minions-repos` | [pypi.org → Account Settings → API tokens](https://pypi.org/manage/account/#api-tokens) |
...
### Web App (Playground)
- **Netlify site name**: `minions-repos-web`
- **GitHub repo**: `mxn2020/minions-repos`
- **Base directory**: `apps/web`
- **Build command**: `pnpm run build`
- **Publish directory**: `apps/web/dist`
- **Custom domain**: `repos.minions.wtf`

### Documentation
- **Netlify site name**: `minions-repos-docs`
- **GitHub repo**: `mxn2020/minions-repos`
- **Base directory**: `apps/docs`
- **Build command**: `pnpm run build`
- **Publish directory**: `apps/docs/dist`
- **Custom domain**: `repos.minions.help`

### Blog
- **Netlify site name**: `minions-repos-blog`
- **GitHub repo**: `mxn2020/minions-repos`
- **Base directory**: `apps/blog`
- **Build command**: `pnpm run build`
- **Publish directory**: `apps/blog/dist`
- **Custom domain**: `repos.minions.blog`
...
|--------|------|------|-------|
| Docs | CNAME | `repos.minions.help` | _(Netlify subdomain)_ |
| Blog | CNAME | `repos.minions.blog` | _(Netlify subdomain)_ |
| App  | CNAME | `repos.minions.wtf` | _(Netlify subdomain)_ |
...
Your packages:
- SDK: [`@minions-repos/sdk`](https://www.npmjs.com/package/@minions-repos/sdk)
- CLI: [`@minions-repos/cli`](https://www.npmjs.com/package/@minions-repos/cli)
...
Your package: [`minions-repos`](https://pypi.org/project/minions-repos/)
...
| Item | Value |
|------|-------|
| Project | `minions-repos` |
| SDK (npm) | `@minions-repos/sdk` |
| CLI (npm) | `@minions-repos/cli` |
| Python (PyPI) | `minions-repos` |
| GitHub | `github.com/mxn2020/minions-repos` |
| Docs domain | `repos.minions.help` |
| Blog domain | `repos.minions.blog` |
| App domain | `repos.minions.wtf` |
